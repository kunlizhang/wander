...
function EditItineraryPage() {
    ...
    return (
        ...
        <div className="flex flex-col h-screen w-96 bg-white">
                                                ...
                                                >
                                                    {(provided) => (
                                                        ...
                                                        >
                                                            ...
                                                            {destination}
                                                            <svg className="w-5 h-5 ml-auto text-primaryGreen2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="p-4">
                <button 
                    className="w-full py-3 bg-primaryGreen2 text-white rounded-lg font-semibold"
                    onClick={() => navigate(-1)}
                >
                    Confirm
                </button>
